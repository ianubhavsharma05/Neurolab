        ...
        <div className="bg-card rounded-xl border border-border p-6 shadow-md">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-muted-foreground">Certified Identity Lock</span>
            </div>
          </div>
          ...
          <Button 
            variant="outline" 
            type="button" 
            className="w-full bg-white/5 border-white/10 hover:bg-white/10 text-white flex items-center justify-center gap-2 group"
            onClick={() => {
              toast.info('Requesting Secure Google Handshake...');
              loginWithGoogle().catch(e => toast.error(e.message));
            }}
          >
